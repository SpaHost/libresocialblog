...
echo '
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
        <a class="brand" href="./index.html">Libre Social Blog</a>
    ...
    <div class="row">
      <div class="header">
        <div class="row">
          ...
          <div class="title">
            <h3>Libre Social Blog</h3>
            <i>Making bloggers more free</i>
          </div>
...
echo '
      <form action="?post=1" method="post">
        ...
        <input type="text" class="span3" name="author" id="author" placeholder="Autor">
...
echo '
  ...
  $timestamp = strtotime($_POST['date'].' '.$_POST['hour'].':'.$_POST['min'].':00 +0100');
...
if ($data3 == '<p></p>') {
  ...
  if ($_POST['title']){
    ...
    $ttdia = date('j', $timestamp);
    $ttmes = date('n', $timestamp);
    $ttano = date('Y', $timestamp);

    $db->query("INSERT INTO lb_news SET title='$data1', news='$data2', news_extend='$data3', author='Kumix', category='$data5', oday='$ttdia', omonth='$ttmes', oyear='$ttano', ttime='$timestamp' ");
  }
...
<script src="/js/wysihtml5-es.js"></script>
